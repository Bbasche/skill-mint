...
export declare class WebKwil extends Kwil<EnvironmentType.BROWSER> {
     ...
     */
    call<T extends Object>(actionBody: CallBody, kwilSigner?: KwilSigner): Promise<GenericResponse<MsgReceipt<T>>>;
}
