...
import { ActionSchema, Attribute, Column, Extension, Index, Table, Procedure, ForeignProcedure, DataInfo, ProcedureReturn, NamedType } from './database';
import { PayloadType } from './enums';
import { AccountId } from './network';
/**
 * `AllPayloads` is the union of all payload types.
 */
export type AllPayloads = UnencodedActionPayload<PayloadType.CALL_ACTION | PayloadType.EXECUTE_ACTION> | TransferPayload | RawStatementPayload;
