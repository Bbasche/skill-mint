...
const payloadTx_1 = require("./payloadTx");
...
class DB {
    ...
    constructor(kwil, payloadType, options) {
        this.kwil = objects_1.objects.requireNonNil(kwil, 'Client is required for DbBuilder. Please pass a valid Kwil client.');
        this.payloadType = objects_1.objects.requireNonNil(payloadType, 'PayloadType is required for DbBuilder. Please pass a valid PayloadType.');
        ...
        objects_1.objects.validateOptionalFields(options, ['description', 'nonce']);
     ...
     */
    static createTx(kwil, payloadType, options) {
     ...
     */
    async buildTx() {
        let cleanedPayload = this.payload;
